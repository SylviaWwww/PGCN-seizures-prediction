...
model.load_state_dict(torch.load("trainResults/chb15/noLocal/pgcn_chb15.pth", map_location=device))
model.eval()
...
# 保存评估报告到文件
with open("trainResults/chb15/noLocal/evaluation_report.txt", "w") as f:
