...
# 加载数据
file_path = "patient_dataset/dataset_chb15.h5"  # 请确保该文件路径与实际数据文件路径一致
...
for epoch in range(num_epochs):
    ...
    if val_acc_epoch > best_val_acc:
        ...
        checkpoint_name = "trainResults/chb15/pgcn_chb15.pth"
        torch.save(model.state_dict(), checkpoint_name)
        print(f"Saved best model to {checkpoint_name}")

# 导出训练日志到 Excel
df = pd.DataFrame(history)
excel_path = "trainResults/chb15/chb15results.xlsx"
...
report_excel_path = "trainResults/chb15/chb15_classification_report.xlsx"
...
plt.legend()
loss_plot_path = "trainResults/chb15/chb15_loss_curve.png"
...
plt.legend()
acc_plot_path = "trainResults/chb15/chb15_accuracy_curve.png"
